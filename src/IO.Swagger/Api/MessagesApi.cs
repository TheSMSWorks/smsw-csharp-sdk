...
namespace IO.Swagger.Api
{
        ...
        public interface IMessagesApi : IApiAccessor
    {
        ...
        ApiResponse<DeletedMessageResponse> DeleteMessageWithHttpInfo (string messageid);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<SendMessageResponse> MessageSendPostWithHttpInfo (Message body);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<DeletedMessageResponse> DeleteMessageAsync (string messageid);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedMessageResponse>> DeleteMessageAsyncWithHttpInfo (string messageid);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SendMessageResponse> MessageSendPostAsync (Message body);
        ...
        System.Threading.Tasks.Task<ApiResponse<SendMessageResponse>> MessageSendPostAsyncWithHttpInfo (Message body);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        public partial class MessagesApi : IMessagesApi
    {
        ...
        /// <param name="messageid">The ID of the message you would like returned</param>
        /// <returns>DeletedMessageResponse</returns>
        public DeletedMessageResponse DeleteMessage (string messageid)
        {
             ApiResponse<DeletedMessageResponse> localVarResponse = DeleteMessageWithHttpInfo(messageid);
             return localVarResponse.Data;
        }
        ...
        /// <param name="messageid">The ID of the message you would like returned</param>
        /// <returns>ApiResponse of DeletedMessageResponse</returns>
        public ApiResponse< DeletedMessageResponse > DeleteMessageWithHttpInfo (string messageid)
        {
            // verify the required parameter 'messageid' is set
            if (messageid == null)
        ...
        /// <param name="messageid">The ID of the message you would like returned</param>
        /// <returns>Task of DeletedMessageResponse</returns>
        public async System.Threading.Tasks.Task<DeletedMessageResponse> DeleteMessageAsync (string messageid)
        {
             ApiResponse<DeletedMessageResponse> localVarResponse = await DeleteMessageAsyncWithHttpInfo(messageid);
             return localVarResponse.Data;
        ...
        /// <param name="messageid">The ID of the message you would like returned</param>
        /// <returns>Task of ApiResponse (DeletedMessageResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedMessageResponse>> DeleteMessageAsyncWithHttpInfo (string messageid)
        {
            // verify the required parameter 'messageid' is set
            if (messageid == null)
                throw new ApiException(400, "Missing required parameter 'messageid' when calling MessagesApi->DeleteMessage");
        ...
        /// <param name="body">Message properties</param>
        /// <returns>SendMessageResponse</returns>
        public SendMessageResponse MessageSendPost (Message body)
        {
             ApiResponse<SendMessageResponse> localVarResponse = MessageSendPostWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">Message properties</param>
        /// <returns>ApiResponse of SendMessageResponse</returns>
        public ApiResponse< SendMessageResponse > MessageSendPostWithHttpInfo (Message body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling MessagesApi->MessageSendPost");
        ...
        /// <param name="body">Message properties</param>
        /// <returns>Task of SendMessageResponse</returns>
        public async System.Threading.Tasks.Task<SendMessageResponse> MessageSendPostAsync (Message body)
        {
             ApiResponse<SendMessageResponse> localVarResponse = await MessageSendPostAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Message properties</param>
        /// <returns>Task of ApiResponse (SendMessageResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SendMessageResponse>> MessageSendPostAsyncWithHttpInfo (Message body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling MessagesApi->MessageSendPost");
