...
namespace IO.Swagger.Model
{
        ...
        public partial class BatchMessage :  IEquatable<BatchMessage>, IValidatableObject
    {
        ...
        /// <param name="ttl">The number of minutes before the message is deleted. Optional. Omit to prevent delivery report deletion. Integer..</param>
        public BatchMessage(string sender = default(string), List<string> destinations = default(List<string>), string content = default(string), string deliveryreporturl = default(string), string schedule = default(string), string tag = default(string), decimal? ttl = default(decimal?))
        {
        ...
        /// </summary>
        /// <value>The number of minutes before the message is deleted. Optional. Omit to prevent delivery report deletion. Integer.</value>
