...
namespace IO.Swagger.Model
{
        ...
        public partial class SendMessageResponse :  IEquatable<SendMessageResponse>, IValidatableObject
    {
        ...
        public SendMessageResponse(string messageid = default(string), string status = default(string), decimal? credits = default(decimal?), decimal? creditsUsed = default(decimal?))
        {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for SendMessageResponse and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (credits == null)
            {
                throw new InvalidDataException("credits is a required property for SendMessageResponse and cannot be null");
            }
            else
            {
                this.Credits = credits;
            }
            // to ensure "creditsUsed" is required (not null)
            if (creditsUsed == null)
            {
                throw new InvalidDataException("creditsUsed is a required property for SendMessageResponse and cannot be null");
            }
            else
            {
