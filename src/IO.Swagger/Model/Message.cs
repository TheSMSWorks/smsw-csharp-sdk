...
namespace IO.Swagger.Model
{
        ...
        public partial class Message :  IEquatable<Message>, IValidatableObject
    {
        ...
        public Message(string sender = default(string), string destination = default(string), string content = default(string), string deliveryreporturl = default(string), string schedule = default(string), string tag = default(string), decimal? ttl = default(decimal?), List<string> responseemail = default(List<string>), Object metadata = default(Object))
        {
